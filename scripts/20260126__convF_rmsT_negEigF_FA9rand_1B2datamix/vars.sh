...
STEP0_HF_PATH="${out_hf_dir}/${STEP0_DIR}"
STEP1_HF_PATH="${out_hf_dir}/${STEP1_DIR}"
STEP2_HF_PATH="${out_hf_dir}/${STEP2_DIR}"
...
base_model="${base_model_hfac}/${base_model_name}"
tokenizer="${base_model_hfac}/${base_model_name}"
